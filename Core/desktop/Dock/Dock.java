...
public class Dock extends JLayeredPane implements MouseListener
{
	...
	private void Components()
	{
		DockIcons = new JLabel[2];
			DockIcons[0] = new JLabel(new ImageIcon("Core/img/dockIcons/system-log-out.png"));
				DockIcons[0].addMouseListener(this);
				DockIcons[0].setToolTipText("Log Out of Puma");
			DockIcons[1] = new JLabel(new ImageIcon("Core/img/dockIcons/preferences-system.png"));	
	...
	public void mouseClicked(MouseEvent event)
	{
		...
		{	
			//System.out.println("INFO: Showing Desktop Preferences JInternalFrame");
